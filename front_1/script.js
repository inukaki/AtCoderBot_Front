...
if (existList) {
    ...
    function displayContestsList(data) {
        ...
        data.forEach(item => {
            ...
            newLink.href = `contest.html?ID=${item.virtualContestID}`;
            ...
            // <div class="listGroup">
            //     <a class="listLink" href="contest.html?ID=0"></a>
            //     <div class="listItem">
...
const existCreate = document.getElementById("create");
if (existCreate) {
    function addTextBox() {
...
const existContest = document.getElementById("contest");
if (existContest) {
    // クエリパラメータを取得する関数
